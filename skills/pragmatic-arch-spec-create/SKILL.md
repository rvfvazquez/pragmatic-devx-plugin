...
**Do not use when:**
- An arch spec already exists and the user wants to modify it → use `pragmatic-arch-spec-update`
- An arch spec already exists and the user wants a quality review → use `pragmatic-arch-spec-validate`
...
> - Update decisions or component boundaries → use `pragmatic-arch-spec-update`
> - Review its quality → use `pragmatic-arch-spec-validate`
>
